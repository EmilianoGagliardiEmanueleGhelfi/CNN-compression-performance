...
def main():
    ...
    get_model_perf(evaluate, model.net_name, model.test_data.images, output_node, model.test_data.images,
                   model.test_data.labels,input_placeholder,label_placeholder)
    ...
    get_model_perf(evaluate, "model_quant", model.test_data.images, output_node, model.test_data.images,
                   model.test_data.labels,input_placeholder,label_placeholder)
